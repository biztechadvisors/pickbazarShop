...
import { INFalg } from '@/components/icons/flags/INFlag';
import { INFlagRound } from '@/components/icons/flags/INFlagRound';
...
export let languageMenu =[
  ...
  },
  {
    ...
    name: "हिन्दी",
    value: "hi",
    icon: <INFalg width="20px" height="15px" />,
    iconMobile: <INFlagRound />
  },
  {
    id: "zh",
    name: "中国人",
