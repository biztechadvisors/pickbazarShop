    ...
    <div className="relative">
      ...
      >
        <input
          ...
          className={`p-4 pr-9 flex h-12 w-full appearance-none items-center rounded border border-border-base text-sm text-heading font-medium transition duration-300 ease-in-out focus:border-accent focus:outline-0 focus:ring-0 line-clamp-1 invalid:border-red-500 ${disabled ? 'cursor-not-allowed border-[#D4D8DD] bg-[#EEF1F4]' : ''
            }`}
          disabled={disabled}
        />
      </Autocomplete>
